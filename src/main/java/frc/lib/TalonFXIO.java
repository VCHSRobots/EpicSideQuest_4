...
public class TalonFXIO implements MotorIO {
  ...
  public BooleanSupplier forwardLimitReachedSupplier = () -> false;
  public BooleanSupplier reverseLimitReachedSupplier = () -> false;
  ...
  public TalonFXIO(ServoMotorSubsystemConfig config) {
    ...
    motionMagicPositionControl.Velocity =
        this.config.fxConfig.MotionMagic.MotionMagicCruiseVelocity;
    motionMagicPositionControl.Acceleration =
        this.config.fxConfig.MotionMagic.MotionMagicAcceleration;
    motionMagicPositionControl.Jerk = this.config.fxConfig.MotionMagic.MotionMagicJerk;
  }
  ...
  public void changeMotionMagicProfile(double velocityR, double accelerationR, double jerkR) {
    motionMagicPositionControl
        .withVelocity(velocityR)
        .withAcceleration(accelerationR)
        .withJerk(jerkR);
  }
  ...
  public void setMotionMagicSetpoint(double units) {
    talon.setControl(
        motionMagicPositionControl
            ...
            .withLimitForwardMotion(forwardLimitReachedSupplier.getAsBoolean())
            .withLimitForwardMotion(reverseLimitReachedSupplier.getAsBoolean()));
  }
